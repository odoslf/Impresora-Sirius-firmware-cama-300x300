...
#define STRING_CONFIG_H_AUTHOR "SIRIUS 300x300 IDEX - odoslf - Marlin 2.1.2.8"
...
#define CUSTOM_MACHINE_NAME "SIRIUS 300 IDEX"
...
#define HOTEND_OFFSET_X { 0.0, 0.00 }
#define HOTEND_OFFSET_Y { 0.0, 0.50 }
